...
public:
    ...
    // PUBLIC METHODS
    void init();    // Pinmodes
    void setMotorSpeed(int pwm, int analogPin1, int analogPin2, int speed); // Set speed for M1.
    void setSpeeds(int m1Speed, int m2Speed,int m3Speed, int m4Speed);      // Set speed for all Motors.
    void setMotorBrake(int pwm, int analogPin1, int analogPin2, int brake); // Brake M1.
